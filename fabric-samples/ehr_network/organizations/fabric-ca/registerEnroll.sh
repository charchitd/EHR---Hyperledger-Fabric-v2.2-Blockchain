...
# # ======================= Hospital _ Peer 1 MSP ===================================
#   infoln "Generating the peer1 msp"
#   set -x
#   fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca-hospitals -M ${PWD}/organizations/peerOrganizations/hospitals.ehr.com/peers/peer1.hospitals.ehr.com/msp --csr.hosts peer1.hospitals.ehr.com --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
#   { set +x; } 2>/dev/null

#   cp ${PWD}/organizations/peerOrganizations/hospitals.ehr.com/msp/config.yaml ${PWD}/organizations/peerOrganizations/hospitals.ehr.com/peers/peer1.hospitals.ehr.com/msp/config.yaml
...
function createOrg2() {
  ...
  infoln "Registering the org admin"
  set -x
  fabric-ca-client register --caname ca-patients --id.name org2admin --id.secret org2adminpw --id.type admin --tls.certfiles ${PWD}/organizations/fabric-ca/org2/tls-cert.pem
  { set +x; } 2>/dev/null
