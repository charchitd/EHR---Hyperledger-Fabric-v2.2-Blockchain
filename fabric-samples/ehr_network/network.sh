...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    # Delete Generated Wallets
    infoln "Deleting Generated Wallets"

    cd ../src/javascript/wallet/
    rm adminHospital.id Hospitaluser1.id

    cd ../wallet2/
    rm adminPatient.id Patientuser2.id
...
# Parse commandline argsCOMPOSE_
