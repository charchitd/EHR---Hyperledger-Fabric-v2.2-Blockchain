...
const logger = log4js.getLogger('HLF-Network');
...
app.post('/users', async function (req, res) {
    ...
    let response = await helper.getRegisteredUser(username, orgName, userId, true);
...
app.post('/users/login', async function (req, res) {
    ...
    let isUserRegistered = await helper.isUserRegistered(username, orgName, userId);
...
app.post('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
    try {
        ...
        let message = await invoke.invokeTransaction(channelName, chaincodeName, fcn, args, req.username, req.orgname, req.userId, transient);
...
app.get('/qscc/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
    try {
        ...
        let response_payload = await qscc.qscc(channelName, chaincodeName, args, fcn, req.username, req.orgname, req.userId);
